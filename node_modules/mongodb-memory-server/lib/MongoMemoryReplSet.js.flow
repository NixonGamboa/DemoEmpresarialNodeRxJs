// @flow
/**
 * Flowtype definitions for MongoMemoryReplSet
...
declare export default class MongoMemoryReplSet mixins events.EventEmitter {
  servers: MongoMemoryServer[];
  opts: MongoMemoryReplSetOptsT;
  debug: DebugFn;
  _state: "init" | "running" | "stopped";
  admin: Admin;
  constructor(opts?: $Shape<MongoMemoryReplSetOptsT>): this;
   ...
   */
  getInstanceOpts(
    baseOpts?: MongoMemoryInstancePropBaseT
  ): MongoMemoryInstancePropT;
