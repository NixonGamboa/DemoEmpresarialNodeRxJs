...
var MongoInstance = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, new Promise(function (resolve) {
                                if (_this.childProcess) {
                                    _this.childProcess.once("exit", resolve);
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        if (!(this.killerProcess && !this.killerProcess.killed)) return [3 /*break*/, 4];
                        return [4 /*yield*/, new Promise(function (resolve) {
                                if (_this.killerProcess) {
                                    _this.killerProcess.once("exit", resolve);
                                    _this.killerProcess.kill();
                                }
                            })];
                    case 3:
    ...
    MongoInstance.prototype._launchKiller = function (parentPid, childPid) {
        ...
        var killer = child_process_1.spawn(process.argv[0], [path_1.default.resolve(__dirname, 'mongo_killer.js'), parentPid.toString(), childPid.toString()], { stdio: 'pipe' });
        return killer;
    };
